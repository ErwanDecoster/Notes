<template>
  <div class="flex min-h-[100vh] h-full justify-center items-center">
    <div class="flex flex-col gap-16 items-center -mt-12">
      <h1 class="text-5xl font-semibold">Notes - Connection</h1>
      <div class="grid gap-4 w-80">
        <h2 class="text-3xl font-semibold">Se connecter</h2>
        ...
        <div class="grid gap-2">
          <button form="form" type="submit" class="text-xl bg-neutral-800 text-white rounded-full py-1 px-2 text-center cursor-pointer">Connection</button>
          <NuxtLink to="/registration" class="text-xl rounded-full py-1 px-2 text-center cursor-pointer">Inscription</NuxtLink>
        </div>
      </div>
    </div>
  </div>
